...
if __name__ == '__main__':
    ...
    '''
    parameters = {'rec_num': [5], 'num_iter': [2000], 'sentry': [20], 'implict_dim': [150],
                  'precision_lambda_1': [1], 'gamma_0': [0.5], 'precision_lambda_2': [16],
                  'alpha_0':[0.2], 'precision_lambda_3':[16], 'beta_1': [0.008], 'beta_2': [0.003],
                  'beta_3':[0.01],
                  'neg_pos_ratio': [0.5]}
    '''
